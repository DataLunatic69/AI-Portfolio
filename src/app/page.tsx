  ...
  return (
    <div className="relative flex min-h-screen flex-col items-center justify-center overflow-hidden px-4 pb-10 md:pb-20">
      ...
      <div className="pointer-events-none absolute inset-x-0 bottom-0 flex justify-center overflow-hidden">
        <motion.div
          className="hidden animated-bg-text bg-gradient-to-b from-neutral-500/10 to-neutral-500/0 bg-clip-text text-[10rem] leading-none font-black text-transparent select-none sm:block lg:text-[16rem]"
      ...
      <div className="absolute top-6 right-8 z-20">
        <GithubButton
          ...
          label="Star"
          size={'sm'}
          repoUrl="https://github.com/DataLunatic69/portfolio"
        />
      </div>
